...
namespace SocketIOClient
{
    public class SocketIO
    {
        ...
        private async Task DoEmitAsync(string eventName, int packetId, object obj)
        {
            var builder = new StringBuilder();
        ...
        {
            _packetId++;
            await DoEmitAsync(eventName, _packetId, obj);
        }

        public async Task EmitAsync(string eventName, EventHandler callback)
        {
            _packetId++;
            Callbacks.Add(_packetId, callback);
            await DoEmitAsync(eventName, _packetId, null);
        }
